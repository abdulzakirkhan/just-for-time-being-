      ...
      <div className="flex-1 flex flex-col items-start justify-start rounded-t-3xl bg-zinc-900  h-full py-6 gap-3 relative">
        {cart && cart?.length > 0 ? (
          <>
            ...
            <div className="bg-zinc-800 rounded-t-[60px] w-full h-full flex flex-col items-center justify-center px-4 py-6 gap-24">
              <div className="w-full flex items-center justify-evenly">
                <p className="text-3xl text-zinc-500 font-semibold">Total</p>
                <p className="text-2xl text-orange-500 font-semibold flex items-center justify-center gap-1">
          ...
          <div className="flex items-center justify-center w-full">
            <h1 className="text-3xl text-primary font-bold md:mt-48 text-center">Cart is Empty</h1>
          </div>
        )}
      </div>
    </motion.div>
  ...
  return (
    ...
    >
      ...
      <div className="ml-auto flex items-center justify-center gap-3">
        ...
        <p className="text-xl font-semibold text-primary">{data?.quantity}</p>
        <motion.div
          {...buttonClick}
