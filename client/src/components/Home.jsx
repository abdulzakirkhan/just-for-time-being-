    ...
    <motion.div className="w-full grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="flex flex-col items-center justify-start gap-6">
        ...
        <p className="text-[40px] text-headingColor md:text-[72px] font-sans font-extrabold tracking-wider">
          The Fastesr Delivery in{" "}
          <span className="text-orange-600">Your City</span>
        </p>
        <p className="text-textColor text-lg">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde debitis saepe aliquid, quas possimus dolorum facilis consequatur? Ex exercitationem ab quam, eveniet eius a maxime necessitatibus voluptas iste aspernatur, quos quisquam in nostrum animi veritatis!
        </p>
        <motion.button
          {...buttonClick}
