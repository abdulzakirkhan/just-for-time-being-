...
const DBHeader = () => {
  ...
  return <div className="w-full flex items-center justify-between gap-3">
    <p className="text-2xl text-headingColor">Welcme to City {user?.name && (
    ...
    <div className="flex items-center justify-center gap-4">
        ...
        <div className="flex items-center justify-center gap-2">
            ...
            <motion.div {...buttonClick} onClick={signOut} className="w-10 h-10 rounded-md cursor-pointer bg-lightOverlay backdrop-blur-md shadow-md flex items-center justify-center">
